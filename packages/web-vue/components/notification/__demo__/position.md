...
<template>
  <a-space>
    ...
    <a-button type="primary" @click="handleNotificationTopLeft">
      Top Left
    </a-button>
    <a-button type="primary" @click="handleNotificationBottomRight">
      Bottom Right
    </a-button>
    <a-button type="primary" @click="handleNotificationBottomLeft">
      Bottom Left
    </a-button>
  </a-space>
</template>
