<template>
  ...
  <div v-if="$slots['extra-footer']" :class="`${prefixCls}-footer-extra-wrapper`">
...
<script setup lang="ts">
  ...
  // 选中谁就更新谁
  function onSelect(value: number | string, type: 'hour' | 'minute' | 'second' | 'ampm' = 'hour') {
    let newValue;
