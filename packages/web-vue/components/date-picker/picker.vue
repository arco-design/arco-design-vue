...
<script setup lang="ts">
  ...
  const emit = defineEmits<{
    ...
    'update:modelValue': [_value: CalendarValue | undefined];
    /**
     * @zh 选中日期发生改变但组件值未改变
     ...
     */
    'select-shortcut': [_shortcut: ShortcutType];
    /**
     * @zh 面板日期改变
     ...
     * @param {string} dateString
     */
    'picker-value-change': [_value: CalendarValue, _date: Date, _dateString: string];
