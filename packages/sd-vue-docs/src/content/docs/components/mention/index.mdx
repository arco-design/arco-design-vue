...
import MentionBasicDemo from '../../../../components/generated/mention/basic.vue';
import mentionBasicSource from '../../../../components/generated/mention/basic.vue?raw';
import MentionPrefixDemo from '../../../../components/generated/mention/prefix.vue';
import mentionPrefixSource from '../../../../components/generated/mention/prefix.vue?raw';

### 基本使用

用于在输入中提及某人或某事，常用于发布、聊天或评论功能。

<DemoBlock source={mentionBasicSource} mainFile="src/mention-basic.vue">

<MentionBasicDemo client:only="vue" />
...
<DemoBlock source={mentionPrefixSource} mainFile="src/mention-prefix.vue">

<MentionPrefixDemo client:only="vue" />
